...
if TYPE_CHECKING:
    ...
    from defectdojo_api_generated.models import AssetAPIScanConfiguration, DeletePreview


class AssetApiScanConfigurationsApi:
    ...
    def create(
        ...
        :type asset_api_scan_configuration_request: AssetAPIScanConfigurationRequest
    ...
    def _create_serialize(
        ...
        if asset_api_scan_configuration_request is not None:
            _body_params = asset_api_scan_configuration_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/asset_api_scan_configurations/',
    ...
    def _delete_preview_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/asset_api_scan_configurations/{id}/delete_preview/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _destroy_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/asset_api_scan_configurations/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': 'PaginatedAssetAPIScanConfigurationList',
        }
        response_data = self.api_client.call_api(*_param, _request_timeout=_request_timeout)
        response_data.read()
        return self.api_client.response_deserialize(
    ...
    def partial_update(
        ...
        patched_asset_api_scan_configuration_request: Optional[PatchedAssetAPIScanConfigurationRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param id: A unique integer value identifying this product_ap i_ scan_ configuration. (required)
        :type id: int
        :param patched_asset_api_scan_configuration_request:
        :type patched_asset_api_scan_configuration_request: PatchedAssetAPIScanConfigurationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patched_asset_api_scan_configuration_request is not None:
            _body_params = patched_asset_api_scan_configuration_request
