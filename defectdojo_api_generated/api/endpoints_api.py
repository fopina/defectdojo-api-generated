...
class EndpointsApi:
    ...
    def endpoints_list(
        ...
        o: Annotated[Optional[List[StrictStr]], Field(description="Ordering  * `host` - Host * `-host` - Host (descending) * `product` - Product * `-product` - Product (descending) * `id` - Id * `-id` - Id (descending)")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The initial index from which to return the results.")] = None,
