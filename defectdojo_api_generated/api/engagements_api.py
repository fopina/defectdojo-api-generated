...
class EngagementsApi:
    ...
    def list(
        ...
        status: Annotated[
            Optional[StrictStr],
            Field(
                description='* `Not Started` - Not Started * `Blocked` - Blocked * `Cancelled` - Cancelled * `Completed` - Completed * `In Progress` - In Progress * `On Hold` - On Hold * `Scheduled` - Scheduled * `Waiting for Resource` - Waiting for Resource'
            ),
        ] = None,
        ...
        :param requester:
        :type requester: int
        :param status: * `Not Started` - Not Started * `Blocked` - Blocked * `Cancelled` - Cancelled * `Completed` - Completed * `In Progress` - In Progress * `On Hold` - On Hold * `Scheduled` - Scheduled * `Waiting for Resource` - Waiting for Resource
        :type status: str
