...
class EngagementsApi:
    ...
    def engagements_list(
        ...
        not_product__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags not present on product")] = None,
        ...
        product__prod_type: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        product__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags present on product (uses OR for multiple values)")] = None,
        product__tags__and: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags to match with an AND expression present on product")] = None,
        report_type: Optional[StrictInt] = None,
        requester: Optional[StrictInt] = None,
        status: Annotated[Optional[StrictStr], Field(description="* `Not Started` - Not Started * `Blocked` - Blocked * `Cancelled` - Cancelled * `Completed` - Completed * `In Progress` - In Progress * `On Hold` - On Hold * `Waiting for Resource` - Waiting for Resource")] = None,
