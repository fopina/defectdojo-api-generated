...
class FindingsApi:
    ...
    def findings_accept_risks_create(
        ...
        created: Annotated[Optional[datetime], Field(description="The date the finding was created inside DefectDojo.  * `None` - Any date * `1` - Today * `2` - Past 7 days * `3` - Past 30 days * `4` - Past 90 days * `5` - Current month * `6` - Current year * `7` - Past year")] = None,
        cvssv3: Optional[StrictStr] = None,
        cvssv3_score: Optional[Union[StrictFloat, StrictInt]] = None,
        cwe: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        var_date: Annotated[Optional[date], Field(description="The date the flaw was discovered.  * `None` - Any date * `1` - Today * `2` - Past 7 days * `3` - Past 30 days * `4` - Past 90 days * `5` - Current month * `6` - Current year * `7` - Past year")] = None,
        defect_review_requested_by: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        ...
        endpoints: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        epss_percentile_max: Annotated[Optional[Union[Annotated[float, Field(le=1.0, strict=True, ge=0.0)], Annotated[int, Field(le=1, strict=True, ge=0)]]], Field(description="The range of EPSS percentiles to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \"less than or equal\"). Leading 0 required.")] = None,
        epss_percentile_min: Annotated[Optional[Union[Annotated[float, Field(le=1.0, strict=True, ge=0.0)], Annotated[int, Field(le=1, strict=True, ge=0)]]], Field(description="The range of EPSS percentiles to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \"less than or equal\"). Leading 0 required.")] = None,
        epss_score_max: Annotated[Optional[Union[Annotated[float, Field(le=1.0, strict=True, ge=0.0)], Annotated[int, Field(le=1, strict=True, ge=0)]]], Field(description="The range of EPSS score percentages to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \"less than or equal\"). Leading 0 required.")] = None,
        epss_score_min: Annotated[Optional[Union[Annotated[float, Field(le=1.0, strict=True, ge=0.0)], Annotated[int, Field(le=1, strict=True, ge=0)]]], Field(description="The range of EPSS score percentages to filter on; the min input is a lower bound, the max is an upper bound. Leaving one empty will skip that bound (e.g., leaving the min bound input empty will filter only on the max bound -- filtering on \"less than or equal\"). Leading 0 required.")] = None,
        false_p: Optional[StrictBool] = None,
        file_path: Optional[StrictStr] = None,
        finding_group: Annotated[Optional[List[Union[StrictFloat, StrictInt]]], Field(description="Multiple values may be separated by commas.")] = None,
        found_by: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        ...
        inherited_tags: Annotated[Optional[List[List[StrictInt]]], Field(description="Internal use tags sepcifically for maintaining parity with product. This field will be present as a subset in the tags field")] = None,
        is_mitigated: Optional[StrictBool] = None,
        jira_change: Annotated[Optional[datetime], Field(description="The date the linked Jira issue was last modified.  * `None` - Any date * `1` - Today * `2` - Past 7 days * `3` - Past 30 days * `4` - Past 90 days * `5` - Current month * `6` - Current year * `7` - Past year")] = None,
        jira_creation: Annotated[Optional[datetime], Field(description="The date a Jira issue was created from this finding.  * `None` - Any date * `1` - Today * `2` - Past 7 days * `3` - Past 30 days * `4` - Past 90 days * `5` - Current month * `6` - Current year * `7` - Past year")] = None,
        last_reviewed: Annotated[Optional[datetime], Field(description="Provides the date the flaw was last 'touched' by a tester.  * `None` - Any date * `1` - Today * `2` - Past 7 days * `3` - Past 30 days * `4` - Past 90 days * `5` - Current month * `6` - Current year * `7` - Past year")] = None,
        last_reviewed_by: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        last_status_update: Optional[datetime] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
        mitigated: Annotated[Optional[datetime], Field(description="Denotes if this flaw has been fixed by storing the date it was fixed.  * `None` - Any date * `1` - Today * `2` - Past 7 days * `3` - Past 30 days * `4` - Past 90 days * `5` - Current month * `6` - Current year * `7` - Past year")] = None,
        ...
        product_lifecycle: Annotated[Optional[StrictStr], Field(description="Comma separated list of exact product lifecycles")] = None,
        ...
        reporter: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        review_requested_by: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        reviewers: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        ...
        sast_source_line: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        sast_source_object: Optional[StrictStr] = None,
        scanner_confidence: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        ...
        sonarqube_issue: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        ...
        tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags (uses OR for multiple values)")] = None,
        tags__and: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags to match with an AND expression")] = None,
        test: Optional[StrictInt] = None,
        test__engagement: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        test__engagement__product: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        test__engagement__product__prod_type: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        test__engagement__product__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags present on product (uses OR for multiple values)")] = None,
        test__engagement__product__tags__and: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags to match with an AND expression present on product")] = None,
        test__engagement__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags present on engagement (uses OR for multiple values)")] = None,
        test__engagement__tags__and: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags to match with an AND expression present on engagement")] = None,
        test__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags present on test (uses OR for multiple values)")] = None,
        test__tags__and: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags to match with an AND expression present on test")] = None,
        test__test_type: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        ...
        if planned_remediation_date is not None:
            if isinstance(planned_remediation_date, date):
                _query_params.append(
                    (
                        'planned_remediation_date',
                        planned_remediation_date.strftime(
                            self.api_client.configuration.date_format
                        )
                    )
                )
    ...
    def findings_list(
        ...
        planned_remediation_date: Optional[date] = None,
        planned_remediation_version: Optional[StrictStr] = None,
        prefetch: Annotated[Optional[List[StrictStr]], Field(description="List of fields for which to prefetch model instances and add those to the response")] = None,
        product_lifecycle: Annotated[Optional[StrictStr], Field(description="Comma separated list of exact product lifecycles")] = None,
        product_name: Annotated[Optional[StrictStr], Field(description="exact product name")] = None,
        product_name_contains: Annotated[Optional[StrictStr], Field(description="exact product name")] = None,
        publish_date: Optional[date] = None,
        references: Optional[StrictStr] = None,
        related_fields: Annotated[Optional[StrictBool], Field(description="Expand finding external relations (engagement, environment, product,                                             product_type, test, test_type)")] = None,
        reporter: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        review_requested_by: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        reviewers: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        risk_acceptance: Optional[Union[StrictFloat, StrictInt]] = None,
    ...
    def findings_metadata_destroy(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this finding.")],
        name: Annotated[StrictInt, Field(description="name of the metadata to retrieve. If name is empty, return all the                                     metadata associated with the finding")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
