...
class FindingsApi:
    ...
    def findings_accept_risks_create(
        ...
        cvssv4: Optional[StrictStr] = None,
        cvssv4_score: Optional[Union[StrictFloat, StrictInt]] = None,
        cwe: Annotated[
        ...
        fix_available: Optional[StrictBool] = None,
        ...
        known_exploited: Optional[StrictBool] = None,
        ...
        product_name_contains: Annotated[Optional[StrictStr], Field(description='Product Name Contains')] = None,
        publish_date: Optional[date] = None,
        ransomware_used: Optional[StrictBool] = None,
        ...
        :param kev_date:
        :type kev_date: date
        :param known_exploited:
        :type known_exploited: bool
        ...
        :param product_name_contains: Product Name Contains
        :type product_name_contains: str
        :param publish_date:
        :type publish_date: date
        :param ransomware_used:
        :type ransomware_used: bool
        :param references:
        :type references: str
    ...
    def _findings_accept_risks_create_serialize(
        ...
        if cvssv4 is not None:
            _query_params.append(('cvssv4', cvssv4))

        if cvssv4_score is not None:
            _query_params.append(('cvssv4_score', cvssv4_score))
        ...
        if fix_available is not None:
            _query_params.append(('fix_available', fix_available))

        if fix_version is not None:
            _query_params.append(('fix_version', fix_version))
        ...
        if kev_date is not None:
            if isinstance(kev_date, date):
                _query_params.append(('kev_date', kev_date.strftime(self.api_client.configuration.date_format)))
            else:
                _query_params.append(('kev_date', kev_date))

        if known_exploited is not None:
            _query_params.append(('known_exploited', known_exploited))
        ...
        if ransomware_used is not None:
            _query_params.append(('ransomware_used', ransomware_used))
