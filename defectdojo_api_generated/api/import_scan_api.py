...
class ImportScanApi:
    ...
    def import_scan_create(
        ...
        tags: Annotated[Optional[List[Annotated[str, Field(min_length=1, strict=True)]]], Field(description="Add tags that help describe this scan.")] = None,
        close_old_findings: Annotated[Optional[StrictBool], Field(description="Select if old findings no longer present in the report get closed as mitigated when importing. If service has been set, only the findings for this service will be closed.")] = None,
        close_old_findings_product_scope: Annotated[Optional[StrictBool], Field(description="Select if close_old_findings applies to all findings of the same type in the product. By default, it is false meaning that only old findings of the same type in the engagement are in scope.")] = None,
        version: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="Version that was scanned.")] = None,
