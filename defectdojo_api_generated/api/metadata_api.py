...
class MetadataApi:
    ...
    def list(
        ...
        name_case_insensitive: Optional[StrictStr] = None,
        offset: Annotated[
            Optional[StrictInt], Field(description='The initial index from which to return the results.')
        ] = None,
        product: Optional[StrictInt] = None,
        value: Optional[StrictStr] = None,
        value_case_insensitive: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param name:
        :type name: str
        :param name_case_insensitive:
        :type name_case_insensitive: str
        :param offset: The initial index from which to return the results.
        :type offset: int
        :param product:
        :type product: int
        :param value:
        :type value: str
        :param value_case_insensitive:
        :type value_case_insensitive: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _list_serialize(
        ...
        if name_case_insensitive is not None:
            _query_params.append(('name_case_insensitive', name_case_insensitive))
        ...
        if value_case_insensitive is not None:
            _query_params.append(('value_case_insensitive', value_case_insensitive))
