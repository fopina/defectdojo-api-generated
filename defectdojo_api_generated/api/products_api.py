...
class ProductsApi:
    ...
    def products_list(
        ...
        created: Annotated[Optional[datetime], Field(description="* `None` - Any date * `1` - Today * `2` - Past 7 days * `3` - Past 30 days * `4` - Past 90 days * `5` - Current month * `6` - Current year * `7` - Past year")] = None,
        ...
        prod_numeric_grade: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        prod_type: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        product_manager: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        regulations: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        ...
        team_manager: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        technical_contact: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        tid: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        updated: Annotated[Optional[datetime], Field(description="* `None` - Any date * `1` - Today * `2` - Past 7 days * `3` - Past 30 days * `4` - Past 90 days * `5` - Current month * `6` - Current year * `7` - Past year")] = None,
        user_records: Annotated[Optional[List[StrictInt]], Field(description="Multiple values may be separated by commas.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
