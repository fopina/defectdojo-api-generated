...
class ReimportScanApi:
    ...
    def reimport_scan_create(
        ...
        engagement_end_date: Annotated[Optional[date], Field(description="End Date for Engagement. Default is current time + 365 days. Required format year-month-day")] = None,
        source_code_management_uri: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=600)]], Field(description="Resource link to source code")] = None,
        ...
        build_id: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="ID of the build that was scanned.")] = None,
        branch_tag: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="Branch or Tag that was scanned.")] = None,
        commit_hash: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="Commit that was scanned.")] = None,
        api_scan_configuration: Optional[StrictInt] = None,
        service: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="A service is a self-contained piece of functionality within a Product. This is an optional field which is used in deduplication and closing of old findings when set. This affects the whole engagement/product depending on your deduplication scope.")] = None,
        group_by: Annotated[Optional[StrictStr], Field(description="Choose an option to automatically group new findings by the chosen option.  * `component_name` - Component Name * `component_name+component_version` - Component Name + Version * `file_path` - File path * `finding_title` - Finding Title")] = None,
        create_finding_groups_for_all_findings: Annotated[Optional[StrictBool], Field(description="If set to false, finding groups will only be created when there is more than one grouped finding")] = None,
        apply_tags_to_findings: Annotated[Optional[StrictBool], Field(description="If set to True, the tags will be applied to the findings")] = None,
        apply_tags_to_endpoints: Annotated[Optional[StrictBool], Field(description="If set to True, the tags will be applied to the endpoints")] = None,
        do_not_reactivate: Annotated[Optional[StrictBool], Field(description="Select if the import should ignore active findings from the report, useful for triage-less scanners. Will keep existing findings closed, without reactivating them. For more information check the docs.")] = None,
        test: Optional[StrictInt] = None,
        close_old_findings: Annotated[Optional[StrictBool], Field(description="Select if old findings no longer present in the report get closed as mitigated when importing.")] = None,
        close_old_findings_product_scope: Annotated[Optional[StrictBool], Field(description="Select if close_old_findings applies to all findings of the same type in the product. By default, it is false meaning that only old findings of the same type in the engagement are in scope. Note that this only applies on the first call to reimport-scan.")] = None,
        version: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="Version that will be set on existing Test object. Leave empty to leave existing value in place.")] = None,
        tags: Annotated[Optional[List[Annotated[str, Field(min_length=1, strict=True)]]], Field(description="Modify existing tags that help describe this scan. (Existing test tags will be overwritten)")] = None,
