...
class TestsApi:
    ...
    def tests_list(
        ...
        engagement__product__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags present on product (uses OR for multiple values)")] = None,
        engagement__product__tags__and: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags to match with an AND expression present on product")] = None,
        engagement__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags present on engagement (uses OR for multiple values)")] = None,
        engagement__tags__and: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags to match with an AND expression present on engagement")] = None,
        has_tags: Annotated[Optional[StrictBool], Field(description="Has tags")] = None,
        id: Optional[StrictInt] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
        not_engagement__product__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags not present on product")] = None,
        not_engagement__tags: Annotated[Optional[List[StrictStr]], Field(description="Comma separated list of exact tags not present on engagement")] = None,
