...
class UserContactInfosApi:
    ...
    def list(
        ...
        password_last_reset: Optional[datetime] = None,
        ...
        token_last_reset: Optional[datetime] = None,
        ...
        :param title:
        :type title: str
        :param token_last_reset:
        :type token_last_reset: datetime
    ...
    def _list_serialize(
        ...
        if password_last_reset is not None:
            if isinstance(password_last_reset, datetime):
                _query_params.append(
                    ('password_last_reset', password_last_reset.strftime(self.api_client.configuration.datetime_format))
                )
            else:
                _query_params.append(('password_last_reset', password_last_reset))
        ...
        if token_last_reset is not None:
            if isinstance(token_last_reset, datetime):
                _query_params.append(
                    ('token_last_reset', token_last_reset.strftime(self.api_client.configuration.datetime_format))
                )
            else:
                _query_params.append(('token_last_reset', token_last_reset))
