...
class UsersApi:
    ...
    def users_list(
        ...
        o: Annotated[
            ...
            Field(
                description='Ordering  * `username` - Username * `-username` - Username (descending) * `last_name` - Last name * `-last_name` - Last name (descending) * `first_name` - First name * `-first_name` - First name (descending) * `email` - Email * `-email` - Email (descending) * `is_active` - Is active * `-is_active` - Is active (descending) * `is_superuser` - Is superuser * `-is_superuser` - Is superuser (descending) * `date_joined` - Date joined * `-date_joined` - Date joined (descending) * `last_login` - Last login * `-last_login` - Last login (descending)'
            ),
        ] = None,
        offset: Annotated[
            Optional[StrictInt], Field(description='The initial index from which to return the results.')
        ...
        :type date_joined_after: date
        :param date_joined_before:
        :type date_joined_before: date
        :param email:
        :type email: str
        :param first_name:
        :type first_name: str
        ...
        :param last_login_after:
        :type last_login_after: date
        :param last_login_before:
        :type last_login_before: date
        :param last_name:
        :type last_name: str
        :param limit: Number of results to return per page.
        :type limit: int
        :param o: Ordering  * `username` - Username * `-username` - Username (descending) * `last_name` - Last name * `-last_name` - Last name (descending) * `first_name` - First name * `-first_name` - First name (descending) * `email` - Email * `-email` - Email (descending) * `is_active` - Is active * `-is_active` - Is active (descending) * `is_superuser` - Is superuser * `-is_superuser` - Is superuser (descending) * `date_joined` - Date joined * `-date_joined` - Date joined (descending) * `last_login` - Last login * `-last_login` - Last login (descending)
        :type o: List[str]
        :param offset: The initial index from which to return the results.
        :type offset: int
        :param username:
    ...
    def _users_list_serialize(
        ...
        # process the path parameters
        # process the query parameters
        if date_joined_after is not None:
            if isinstance(date_joined_after, date):
                _query_params.append(
                    ('date_joined_after', date_joined_after.strftime(self.api_client.configuration.date_format))
                )
            else:
                _query_params.append(('date_joined_after', date_joined_after))

        if date_joined_before is not None:
            if isinstance(date_joined_before, date):
                _query_params.append(
                    ('date_joined_before', date_joined_before.strftime(self.api_client.configuration.date_format))
                )
            else:
                _query_params.append(('date_joined_before', date_joined_before))
        ...
        if last_login_after is not None:
            if isinstance(last_login_after, date):
                _query_params.append(
                    ('last_login_after', last_login_after.strftime(self.api_client.configuration.date_format))
                )
            else:
                _query_params.append(('last_login_after', last_login_after))

        if last_login_before is not None:
            if isinstance(last_login_before, date):
                _query_params.append(
                    ('last_login_before', last_login_before.strftime(self.api_client.configuration.date_format))
                )
            else:
    ...
    def _users_reset_api_token_create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/users/{id}/reset_api_token/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
