...
**request_response** | [**BurpRawRequestResponse**](BurpRawRequestResponse.md) |  | [readonly] 
**accepted_risks** | [**List[RiskAcceptance]**](RiskAcceptance.md) |  | [readonly] 
**push_to_jira** | **bool** |  | [optional] [default to False]
**age** | **int** |  | [readonly] 
**sla_days_remaining** | **int** |  | [readonly] 
**finding_meta** | [**List[FindingMeta]**](FindingMeta.md) |  | [readonly] 
**related_fields** | [**FindingRelatedFields**](FindingRelatedFields.md) |  | [readonly] 
**jira_creation** | **datetime** |  | [readonly] 
**jira_change** | **datetime** |  | [readonly] 
**display_status** | **str** |  | [readonly] 
...
**url** | **str** | External reference that provides more information about this flaw. | [readonly] 
