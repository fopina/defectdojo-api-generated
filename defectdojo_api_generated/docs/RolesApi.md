...
------------- | ------------- | -------------
[**roles_list**](RolesApi.md#roles_list) | **GET** /api/v2/roles/ | 
[**roles_retrieve**](RolesApi.md#roles_retrieve) | **GET** /api/v2/roles/{id}/ | 


# **roles_list**
> PaginatedRoleList roles_list(id=id, limit=limit, name=name, offset=offset)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.roles_list(id=id, limit=limit, name=name, offset=offset)
