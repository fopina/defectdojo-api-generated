...
[**users_delete_preview_list**](UsersApi.md#users_delete_preview_list) | **GET** /api/v2/users/{id}/delete_preview/ | 
...
> PaginatedDeletePreviewList users_delete_preview_list(id, limit=limit, offset=offset)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.users_delete_preview_list(id, limit=limit, offset=offset)
        print("The response of UsersApi->users_delete_preview_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->users_delete_preview_list: %s\n" % e)
```
...
# **users_list**
> PaginatedUserList users_list(email=email, first_name=first_name, id=id, is_active=is_active, is_superuser=is_superuser, last_name=last_name, limit=limit, offset=offset, username=username)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.users_list(email=email, first_name=first_name, id=id, is_active=is_active, is_superuser=is_superuser, last_name=last_name, limit=limit, offset=offset, username=username)
