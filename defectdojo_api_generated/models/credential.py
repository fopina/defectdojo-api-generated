...
class Credential(BaseModel):
    ...
    authentication: Optional[StrictStr] = Field(default=None, description="* `Form` - Form Authentication * `SSO` - SSO Redirect")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "username", "role", "authentication", "http_authentication", "description", "url", "login_regex", "logout_regex", "is_valid", "environment", "notes", "prefetch"]
