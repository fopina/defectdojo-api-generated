...
class DeltaStatisticsRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "created": SeverityStatusStatisticsRequest.from_dict(obj["created"]) if obj.get("created") is not None else None,
            "closed": SeverityStatusStatisticsRequest.from_dict(obj["closed"]) if obj.get("closed") is not None else None,
            "reactivated": SeverityStatusStatisticsRequest.from_dict(obj["reactivated"]) if obj.get("reactivated") is not None else None,
            "left untouched": SeverityStatusStatisticsRequest.from_dict(obj["left untouched"]) if obj.get("left untouched") is not None else None
        })
        return _obj
