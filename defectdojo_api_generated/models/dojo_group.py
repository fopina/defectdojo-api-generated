...
class DojoGroup(BaseModel):
    ...
    social_provider: Optional[StrictStr] = Field(default=None, description="Group imported from a social provider.  * `AzureAD` - AzureAD * `Remote` - Remote")
    users: Optional[List[StrictInt]] = None
    prefetch: Optional[DojoGroupPrefetch] = None
    __properties: ClassVar[List[str]] = ["id", "configuration_permissions", "name", "description", "social_provider", "users", "prefetch"]
