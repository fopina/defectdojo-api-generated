...
class DojoGroupMember(BaseModel):
    ...
    role: Optional[StrictInt] = Field(default=None, description="This role determines the permissions of the user to manage the group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": obj.get("user"),
            "role": obj.get("role"),
            "prefetch": DojoGroupMemberPrefetch.from_dict(obj["prefetch"]) if obj.get("prefetch") is not None else None
        })
        return _obj
