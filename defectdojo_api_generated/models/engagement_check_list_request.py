...
class EngagementCheckListRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["session_management", "encryption_crypto", "configuration_management", "authentication", "authorization_and_access_control", "data_input_sanitization_validation", "sensitive_data", "other", "session_issues", "crypto_issues", "config_issues", "auth_issues", "author_issues", "data_issues", "sensitive_issues", "other_issues"]
