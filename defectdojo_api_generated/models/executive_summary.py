...
class ExecutiveSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["engagement_name", "engagement_target_start", "engagement_target_end", "test_type_name", "test_target_start", "test_target_end", "test_environment_name", "test_strategy_ref", "total_findings"]
