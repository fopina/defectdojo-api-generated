...
class FindingCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "notes", "test", "thread_id", "found_by", "url", "tags", "push_to_jira", "vulnerability_ids", "reporter", "title", "date", "sla_start_date", "sla_expiration_date", "cwe", "epss_score", "epss_percentile", "cvssv3", "cvssv3_score", "severity", "description", "mitigation", "impact", "steps_to_reproduce", "severity_justification", "references", "active", "verified", "false_p", "duplicate", "out_of_scope", "risk_accepted", "under_review", "last_status_update", "under_defect_review", "is_mitigated", "mitigated", "numerical_severity", "last_reviewed", "param", "payload", "hash_code", "line", "file_path", "component_name", "component_version", "static_finding", "dynamic_finding", "created", "scanner_confidence", "unique_id_from_tool", "vuln_id_from_tool", "sast_source_object", "sast_sink_object", "sast_source_line", "sast_source_file_path", "nb_occurences", "publish_date", "service", "planned_remediation_date", "planned_remediation_version", "effort_for_fixing", "duplicate_finding", "review_requested_by", "defect_review_requested_by", "mitigated_by", "last_reviewed_by", "sonarqube_issue", "endpoints", "reviewers", "files"]
