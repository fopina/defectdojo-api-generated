...
class FindingPrefetch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["auth_issues", "author_issues", "config_issues", "crypto_issues", "data_issues", "defect_review_requested_by", "duplicate_finding", "endpoint_set", "endpoints", "files", "finding_group_set", "found_by", "last_reviewed_by", "mitigated_by", "notes", "other_issues", "reporter", "review_requested_by", "reviewers", "risk_acceptance_set", "sensitive_issues", "session_issues", "sonarqube_issue", "test", "test_import_set"]
        ...
        if self.defect_review_requested_by:
            for _key_defect_review_requested_by in self.defect_review_requested_by:
                if self.defect_review_requested_by[_key_defect_review_requested_by]:
                    _field_dict[_key_defect_review_requested_by] = self.defect_review_requested_by[_key_defect_review_requested_by].to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auth_issues": dict(
                (_k, EngagementCheckList.from_dict(_v))
                for _k, _v in obj["auth_issues"].items()
            )
            if obj.get("auth_issues") is not None
            else None,
            "author_issues": dict(
                (_k, EngagementCheckList.from_dict(_v))
                for _k, _v in obj["author_issues"].items()
            )
            if obj.get("author_issues") is not None
            else None,
            "config_issues": dict(
                (_k, EngagementCheckList.from_dict(_v))
                for _k, _v in obj["config_issues"].items()
            )
            if obj.get("config_issues") is not None
            else None,
            "crypto_issues": dict(
                (_k, EngagementCheckList.from_dict(_v))
                for _k, _v in obj["crypto_issues"].items()
            )
            if obj.get("crypto_issues") is not None
            else None,
            "data_issues": dict(
                (_k, EngagementCheckList.from_dict(_v))
                for _k, _v in obj["data_issues"].items()
            )
            if obj.get("data_issues") is not None
            else None,
            "defect_review_requested_by": dict(
                (_k, UserStub.from_dict(_v))
                for _k, _v in obj["defect_review_requested_by"].items()
            )
            if obj.get("defect_review_requested_by") is not None
            else None,
            "duplicate_finding": dict(
                (_k, Finding.from_dict(_v))
                for _k, _v in obj["duplicate_finding"].items()
            )
            if obj.get("duplicate_finding") is not None
            else None,
            "endpoint_set": dict(
                (_k, Endpoint.from_dict(_v))
                for _k, _v in obj["endpoint_set"].items()
            )
            ...
            "files": dict(
                (_k, File.from_dict(_v))
                for _k, _v in obj["files"].items()
            )
            if obj.get("files") is not None
            else None,
            "finding_group_set": dict(
                (_k, FindingGroup.from_dict(_v))
                for _k, _v in obj["finding_group_set"].items()
            )
            if obj.get("finding_group_set") is not None
            else None,
            "found_by": dict(
                (_k, TestType.from_dict(_v))
                for _k, _v in obj["found_by"].items()
            )
            if obj.get("found_by") is not None
            else None,
            "last_reviewed_by": dict(
                (_k, UserStub.from_dict(_v))
                for _k, _v in obj["last_reviewed_by"].items()
            )
            if obj.get("last_reviewed_by") is not None
            else None,
            "mitigated_by": dict(
                (_k, UserStub.from_dict(_v))
                for _k, _v in obj["mitigated_by"].items()
            )
            ...
            "other_issues": dict(
                (_k, EngagementCheckList.from_dict(_v))
                for _k, _v in obj["other_issues"].items()
            )
            if obj.get("other_issues") is not None
            else None,
            "reporter": dict(
                (_k, UserStub.from_dict(_v))
                for _k, _v in obj["reporter"].items()
            )
            if obj.get("reporter") is not None
            else None,
            "review_requested_by": dict(
                (_k, UserStub.from_dict(_v))
                for _k, _v in obj["review_requested_by"].items()
            )
            if obj.get("review_requested_by") is not None
            else None,
            "reviewers": dict(
                (_k, UserStub.from_dict(_v))
                for _k, _v in obj["reviewers"].items()
            )
            if obj.get("reviewers") is not None
            else None,
            "risk_acceptance_set": dict(
                (_k, RiskAcceptance.from_dict(_v))
                for _k, _v in obj["risk_acceptance_set"].items()
            )
            if obj.get("risk_acceptance_set") is not None
            else None,
            "sensitive_issues": dict(
                (_k, EngagementCheckList.from_dict(_v))
                for _k, _v in obj["sensitive_issues"].items()
            )
            if obj.get("sensitive_issues") is not None
            else None,
            "session_issues": dict(
                (_k, EngagementCheckList.from_dict(_v))
                for _k, _v in obj["session_issues"].items()
            )
            if obj.get("session_issues") is not None
            else None,
            "sonarqube_issue": dict(
                (_k, SonarqubeIssue.from_dict(_v))
                for _k, _v in obj["sonarqube_issue"].items()
            )
            if obj.get("sonarqube_issue") is not None
            else None,
            "test": dict(
                (_k, Test.from_dict(_v))
                for _k, _v in obj["test"].items()
            )
            if obj.get("test") is not None
            else None,
            "test_import_set": dict(
                (_k, TestImport.from_dict(_v))
                for _k, _v in obj["test_import_set"].items()
            )
