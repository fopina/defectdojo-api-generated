...
class FindingRequest(BaseModel):
    ...
    known_exploited: Optional[StrictBool] = Field(
        default=None, description='Whether this vulnerability is known to have been exploited in the wild.'
    )
    ransomware_used: Optional[StrictBool] = Field(
        default=None,
        description='Whether this vulnerability is known to have been leveraged as part of a ransomware campaign.',
    )
    kev_date: Optional[date] = Field(
        default=None, description='The date the vulnerability was added to the KEV catalog.'
    )
    cvssv3: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=117)]] = Field(
        default=None,
        description='Common Vulnerability Scoring System version 3 (CVSS3) score associated with this finding.',
    )
    ...
    cvssv4_score: Optional[
        Union[Annotated[float, Field(le=10.0, strict=True, ge=0.0)], Annotated[int, Field(le=10, strict=True, ge=0)]]
    ] = Field(
        default=None,
        description='Numerical CVSSv4 score for the vulnerability. If the vector is given, the score is updated while saving the finding. The value must be between 0-10.',
    )
    ...
    fix_available: Optional[StrictBool] = Field(
        default=None, description='Denotes if there is a fix available for this flaw.'
    )
    fix_version: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(
        default=None, description='Version of the affected component in which the flaw is fixed.'
    )
    ...
    unique_id_from_tool: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(
        default=None,
        description='Vulnerability technical id from the source tool. Allows to track unique vulnerabilities over time across subsequent scans.',
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if kev_date (nullable) is None
        # and model_fields_set contains the field
        if self.kev_date is None and 'kev_date' in self.model_fields_set:
            _dict['kev_date'] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                'known_exploited': obj.get('known_exploited'),
                'ransomware_used': obj.get('ransomware_used'),
                'kev_date': obj.get('kev_date'),
