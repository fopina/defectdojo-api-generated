...
class FindingTemplateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tags", "vulnerability_ids", "title", "cwe", "cvssv3", "severity", "description", "mitigation", "impact", "references", "template_match", "template_match_title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": obj.get("tags"),
            "vulnerability_ids": [VulnerabilityIdTemplateRequest.from_dict(_item) for _item in obj["vulnerability_ids"]] if obj.get("vulnerability_ids") is not None else None,
            "title": obj.get("title"),
            "cwe": obj.get("cwe"),
