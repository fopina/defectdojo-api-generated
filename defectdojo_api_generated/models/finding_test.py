...
class FindingTest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "test_type", "engagement", "environment", "branch_tag", "build_id", "commit_hash", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "engagement": FindingEngagement.from_dict(obj["engagement"]) if obj.get("engagement") is not None else None,
            "environment": FindingEnvironment.from_dict(obj["environment"]) if obj.get("environment") is not None else None,
