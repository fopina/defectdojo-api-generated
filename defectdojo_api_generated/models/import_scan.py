...
class ImportScan(BaseModel):
    ...
    close_old_findings: Optional[StrictBool] = Field(default=False, description="Select if old findings no longer present in the report get closed as mitigated when importing. If service has been set, only the findings for this service will be closed.")
    close_old_findings_product_scope: Optional[StrictBool] = Field(default=False, description="Select if close_old_findings applies to all findings of the same type in the product. By default, it is false meaning that only old findings of the same type in the engagement are in scope.")
    version: Optional[StrictStr] = Field(default=None, description="Version that was scanned.")
    test: StrictInt
    __properties: ClassVar[List[str]] = ["scan_date", "minimum_severity", "active", "verified", "endpoint_to_add", "file", "product_type_name", "product_name", "engagement_name", "engagement_end_date", "source_code_management_uri", "test_title", "auto_create_context", "deduplication_on_engagement", "lead", "push_to_jira", "environment", "build_id", "branch_tag", "commit_hash", "api_scan_configuration", "service", "group_by", "create_finding_groups_for_all_findings", "test_id", "engagement_id", "product_id", "product_type_id", "statistics", "apply_tags_to_findings", "apply_tags_to_endpoints", "scan_type", "engagement", "tags", "close_old_findings", "close_old_findings_product_scope", "version", "test"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "close_old_findings": obj.get("close_old_findings") if obj.get("close_old_findings") is not None else False,
