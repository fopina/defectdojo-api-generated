...
class ImportStatistics(BaseModel):
    ...
    ImportStatistics
    """ # noqa: E501
    before: Optional[SeverityStatusStatistics] = Field(default=None, description="Finding statistics as stored in Defect Dojo before the import")
    delta: Optional[DeltaStatistics] = Field(default=None, description="Finding statistics of modifications made by the reimport. Only available when TRACK_IMPORT_HISTORY has not been disabled.")
