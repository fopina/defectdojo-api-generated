...
class JIRAIssue(BaseModel):
    ...
    jira_creation: Optional[datetime] = Field(default=None, description="The date a Jira issue was created from this finding.")
    jira_change: Optional[datetime] = Field(default=None, description="The date the linked Jira issue was last modified.")
    ...
    __properties: ClassVar[List[str]] = ["id", "url", "jira_id", "jira_key", "jira_creation", "jira_change", "jira_project", "finding", "engagement", "finding_group"]
