...
class JIRAProject(BaseModel):
    ...
    custom_fields: Optional[Any] = Field(default=None, description="JIRA custom field JSON mapping of Id to value, e.g. {\"customfield_10122\": [{\"name\": \"8.0.1\"}]}")
    default_assignee: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(default=None, description="JIRA default assignee (name). If left blank then it defaults to whatever is configured in JIRA.")
    jira_labels: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(default=None, description="JIRA issue labels space seperated")
    add_vulnerability_id_to_jira_label: Optional[StrictBool] = None
    push_all_issues: Optional[StrictBool] = Field(default=None, description="Automatically create JIRA tickets for verified findings, assuming enforce_verified_status is True, or for all findings otherwise. Once linked, the JIRA ticket will continue to sync, regardless of status in DefectDojo.")
    enable_engagement_epic_mapping: Optional[StrictBool] = None
    epic_issue_type_name: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="The name of the of structure that represents an Epic")
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="When disabled, Findings will no longer be pushed to Jira, even if they have already been pushed previously.")
    ...
    __properties: ClassVar[List[str]] = ["id", "project_key", "issue_template_dir", "component", "custom_fields", "default_assignee", "jira_labels", "add_vulnerability_id_to_jira_label", "push_all_issues", "enable_engagement_epic_mapping", "epic_issue_type_name", "push_notes", "product_jira_sla_notification", "risk_acceptance_expiration_notification", "enabled", "jira_instance", "product", "engagement", "prefetch"]
