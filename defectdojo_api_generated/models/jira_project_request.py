...
class JIRAProjectRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["project_key", "issue_template_dir", "component", "custom_fields", "default_assignee", "jira_labels", "add_vulnerability_id_to_jira_label", "push_all_issues", "enable_engagement_epic_mapping", "epic_issue_type_name", "push_notes", "product_jira_sla_notification", "risk_acceptance_expiration_notification", "enabled", "jira_instance", "product", "engagement"]
