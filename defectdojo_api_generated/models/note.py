...
class Note(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "author", "editor", "history", "note_type", "entry", "date", "private", "edited", "edit_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "history": [NoteHistory.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None,
