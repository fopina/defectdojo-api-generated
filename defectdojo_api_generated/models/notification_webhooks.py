...
class NotificationWebhooks(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    name: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Name of the incoming webhook")
    url: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(default=None, description="The full URL of the incoming webhook")
    header_name: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Name of the header required for interacting with Webhook endpoint")
    header_value: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Content of the header required for interacting with Webhook endpoint")
    ...
    owner: Optional[StrictInt] = Field(default=None, description="Owner/receiver of notification, if empty processed as system notification")
    __properties: ClassVar[List[str]] = ["id", "name", "url", "header_name", "header_value", "status", "first_error", "last_error", "note", "owner"]
