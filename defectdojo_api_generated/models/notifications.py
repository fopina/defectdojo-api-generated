...
class Notifications(BaseModel):
    ...
    scan_added_empty: Optional[StrictStr] = Field(default=None, description="Triggered whenever an (re-)import has been done (even if that created/updated/closed no findings).  * `slack` - slack * `msteams` - msteams * `mail` - mail * `webhooks` - webhooks * `alert` - alert")
    prefetch: Optional[AppAnalysisPrefetch] = None
    __properties: ClassVar[List[str]] = ["id", "product", "user", "product_type_added", "product_added", "engagement_added", "test_added", "scan_added", "jira_update", "upcoming_engagement", "stale_engagement", "auto_close_engagement", "close_engagement", "user_mentioned", "code_review", "review_requested", "other", "sla_breach", "sla_breach_combined", "risk_acceptance_expiration", "template", "scan_added_empty", "prefetch"]
