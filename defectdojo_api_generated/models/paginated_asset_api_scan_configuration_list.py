...
class PaginatedAssetAPIScanConfigurationList(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [AssetAPIScanConfiguration.from_dict(_item) for _item in obj['results']]
                if obj.get('results') is not None
                else None,
                'prefetch': AssetAPIScanConfigurationPrefetch.from_dict(obj['prefetch'])
