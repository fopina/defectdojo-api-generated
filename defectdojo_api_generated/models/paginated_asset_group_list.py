...
class PaginatedAssetGroupList(BaseModel):
    """
    ...
    results: Optional[List[AssetGroup]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [AssetGroup.from_dict(_item) for _item in obj['results']]
                if obj.get('results') is not None
                else None,
                'prefetch': AssetGroupPrefetch.from_dict(obj['prefetch']) if obj.get('prefetch') is not None else None,
            }
        )
        return _obj
