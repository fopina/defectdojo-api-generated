...
class PaginatedAssetMemberList(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [AssetMember.from_dict(_item) for _item in obj['results']]
                if obj.get('results') is not None
                else None,
                'prefetch': AssetMemberPrefetch.from_dict(obj['prefetch']) if obj.get('prefetch') is not None else None,
            }
        )
        return _obj
