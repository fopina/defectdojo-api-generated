...
class PaginatedOrganizationGroupList(BaseModel):
    """
    ...
    results: Optional[List[OrganizationGroup]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [OrganizationGroup.from_dict(_item) for _item in obj['results']]
                if obj.get('results') is not None
                else None,
                'prefetch': OrganizationGroupPrefetch.from_dict(obj['prefetch'])
