...
class PaginatedOrganizationMemberList(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [OrganizationMember.from_dict(_item) for _item in obj['results']]
                if obj.get('results') is not None
                else None,
                'prefetch': OrganizationMemberPrefetch.from_dict(obj['prefetch'])
