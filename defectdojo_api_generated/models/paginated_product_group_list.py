...
class PaginatedProductGroupList(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ProductGroup.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "prefetch": PaginatedProductGroupListPrefetch.from_dict(obj["prefetch"]) if obj.get("prefetch") is not None else None
        })
        return _obj
