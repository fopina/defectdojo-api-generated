    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignee": dict(
                ...
                for _k, _v in obj["assignee"].items()
            )
            if obj.get("assignee") is not None
            else None,
            "engagement": dict(
                (_k, FindingEngagement.from_dict(_v))
                for _k, _v in obj["engagement"].items()
            )
            if obj.get("engagement") is not None
            else None,
            "responder": dict(
                (_k, UserStub.from_dict(_v))
                for _k, _v in obj["responder"].items()
            )
            if obj.get("responder") is not None
            else None,
            "survey": dict(
                (_k, QuestionnaireEngagementSurvey.from_dict(_v))
                for _k, _v in obj["survey"].items()
            )
