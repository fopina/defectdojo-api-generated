...
class PatchedFindingRequest(BaseModel):
    ...
    title: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=511)]] = Field(default=None, description="A short description of the flaw.")
    ...
    severity: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=200)]] = Field(default=None, description="The severity level of this flaw (Critical, High, Medium, Low, Info).")
    description: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Longer more descriptive information about the flaw.")
    ...
    numerical_severity: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=4)]] = Field(default=None, description="The numerical representation of the severity (S0, S1, S2, S3, S4).")
