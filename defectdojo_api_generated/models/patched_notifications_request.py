...
class PatchedNotificationsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["product", "user", "product_type_added", "product_added", "engagement_added", "test_added", "scan_added", "jira_update", "upcoming_engagement", "stale_engagement", "auto_close_engagement", "close_engagement", "user_mentioned", "code_review", "review_requested", "other", "sla_breach", "sla_breach_combined", "risk_acceptance_expiration", "template", "scan_added_empty"]
