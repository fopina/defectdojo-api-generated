...
class PatchedProductRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tags", "name", "description", "prod_numeric_grade", "business_criticality", "platform", "lifecycle", "origin", "user_records", "revenue", "external_audience", "internet_accessible", "enable_product_tag_inheritance", "enable_simple_risk_acceptance", "enable_full_risk_acceptance", "disable_sla_breach_notifications", "product_manager", "technical_contact", "team_manager", "prod_type", "sla_configuration", "regulations"]
