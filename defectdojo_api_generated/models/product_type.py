...
class ProductType(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "critical_product", "key_product", "updated", "created", "members", "authorization_groups", "prefetch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prefetch": PaginatedProductTypeListPrefetch.from_dict(obj["prefetch"]) if obj.get("prefetch") is not None else None
        })
        return _obj
