...
class ReportGenerate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["executive_summary", "product_type", "product", "engagement", "report_name", "report_info", "test", "endpoint", "endpoints", "findings", "user", "team_name", "title", "user_id", "host", "finding_notes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "executive_summary": ExecutiveSummary.from_dict(obj["executive_summary"]) if obj.get("executive_summary") is not None else None,
            "product_type": ProductType.from_dict(obj["product_type"]) if obj.get("product_type") is not None else None,
            ...
            "host": obj.get("host"),
            "finding_notes": [FindingToNotes.from_dict(_item) for _item in obj["finding_notes"]] if obj.get("finding_notes") is not None else None
        })
        return _obj
