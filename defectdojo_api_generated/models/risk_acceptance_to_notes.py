...
class RiskAcceptanceToNotes(BaseModel):
    """
    RiskAcceptanceToNotes
    """  # noqa: E501

    risk_acceptance_id: Optional[StrictInt] = None
    notes: Optional[List[Note]] = None
    __properties: ClassVar[List[str]] = ['risk_acceptance_id', 'notes']
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.notes:
            ...
            _dict['notes'] = _items
        # set to None if risk_acceptance_id (nullable) is None
        # and model_fields_set contains the field
        if self.risk_acceptance_id is None and 'risk_acceptance_id' in self.model_fields_set:
            _dict['risk_acceptance_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                'risk_acceptance_id': obj.get('risk_acceptance_id'),
