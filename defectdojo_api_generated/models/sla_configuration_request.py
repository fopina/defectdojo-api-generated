...
class SLAConfigurationRequest(BaseModel):
    ...
    restart_sla_on_reactivation: Optional[StrictBool] = Field(
        default=None,
        description='When enabled, findings that were previously mitigated but are reactivated durign reimport will have their SLA period restarted.',
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                'restart_sla_on_reactivation': obj.get('restart_sla_on_reactivation'),
            }
        )
        return _obj
