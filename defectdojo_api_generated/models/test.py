...
class Test(BaseModel):
    ...
    build_id: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(default=None, description="Build ID that was tested, a reimport may update this field.")
    commit_hash: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(default=None, description="Commit hash tested, a reimport may update this field.")
    branch_tag: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(default=None, description="Tag or branch that was tested, a reimport may update this field.")
    ...
    notes: List[Note]
    files: List[File]
    __properties: ClassVar[List[str]] = ["id", "tags", "test_type_name", "finding_groups", "scan_type", "title", "description", "target_start", "target_end", "estimated_time", "actual_time", "percent_complete", "updated", "created", "version", "build_id", "commit_hash", "branch_tag", "engagement", "lead", "test_type", "environment", "api_scan_configuration", "notes", "files"]
