...
class TestCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "engagement", "notes", "tags", "scan_type", "title", "description", "target_start", "target_end", "estimated_time", "actual_time", "percent_complete", "updated", "created", "version", "build_id", "commit_hash", "branch_tag", "lead", "test_type", "environment", "api_scan_configuration", "files"]
