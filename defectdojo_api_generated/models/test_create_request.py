...
class TestCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["engagement", "notes", "tags", "scan_type", "title", "description", "target_start", "target_end", "percent_complete", "version", "build_id", "commit_hash", "branch_tag", "lead", "test_type", "environment", "api_scan_configuration"]
