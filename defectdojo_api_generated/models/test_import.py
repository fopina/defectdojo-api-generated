...
class TestImport(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "test_import_finding_action_set", "created", "modified", "import_settings", "type", "version", "build_id", "commit_hash", "branch_tag", "test", "findings_affected"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "test_import_finding_action_set": [TestImportFindingAction.from_dict(_item) for _item in obj["test_import_finding_action_set"]] if obj.get("test_import_finding_action_set") is not None else None,
