...
class ToolConfiguration(BaseModel):
    ...
    authentication_type: Optional[StrictStr] = Field(default=None, description="* `API` - API Key * `Password` - Username/Password * `SSH` - SSH")
    extras: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Additional definitions that will be consumed by scanner")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "url", "authentication_type", "extras", "username", "auth_title", "tool_type", "prefetch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prefetch": PaginatedToolConfigurationListPrefetch.from_dict(obj["prefetch"]) if obj.get("prefetch") is not None else None
        })
        return _obj
