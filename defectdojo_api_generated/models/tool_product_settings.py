...
class ToolProductSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "setting_url", "product", "name", "description", "url", "tool_project_id", "tool_configuration", "notes", "prefetch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "prefetch": PaginatedToolProductSettingsListPrefetch.from_dict(obj["prefetch"]) if obj.get("prefetch") is not None else None
        })
        return _obj
