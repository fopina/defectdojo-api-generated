...
class User(BaseModel):
    ...
    is_superuser: Optional[StrictBool] = Field(default=None, description="Designates that this user has all permissions without explicitly assigning them.")
    configuration_permissions: Optional[List[Optional[StrictInt]]] = None
    __properties: ClassVar[List[str]] = ["id", "username", "first_name", "last_name", "email", "date_joined", "last_login", "is_active", "is_superuser", "configuration_permissions"]
