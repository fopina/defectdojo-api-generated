...
class UserContactInfo(BaseModel):
    ...
    phone_number: Optional[Annotated[str, Field(strict=True, max_length=15)]] = Field(default=None, description="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.")
    cell_number: Optional[Annotated[str, Field(strict=True, max_length=15)]] = Field(default=None, description="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.")
    ...
    slack_username: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(default=None, description="Email address associated with your slack account")
    slack_user_id: Optional[Annotated[str, Field(strict=True, max_length=25)]] = None
    block_execution: Optional[StrictBool] = Field(default=None, description="Instead of async deduping a finding the findings will be deduped synchronously and will 'block' the user until completion.")
    force_password_reset: Optional[StrictBool] = Field(default=None, description="Forces this user to reset their password on next login.")
    user: StrictInt
    prefetch: Optional[PaginatedUserContactInfoListPrefetch] = None
    __properties: ClassVar[List[str]] = ["id", "user_profile", "title", "phone_number", "cell_number", "twitter_username", "github_username", "slack_username", "slack_user_id", "block_execution", "force_password_reset", "user", "prefetch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": obj.get("user"),
            "prefetch": PaginatedUserContactInfoListPrefetch.from_dict(obj["prefetch"]) if obj.get("prefetch") is not None else None
        })
        return _obj
