...
class UserContactInfoRequest(BaseModel):
    ...
    user: StrictInt
    __properties: ClassVar[List[str]] = ["title", "phone_number", "cell_number", "twitter_username", "github_username", "slack_username", "slack_user_id", "block_execution", "force_password_reset", "user"]
