...
class UserProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user", "user_contact_info", "global_role", "dojo_group_member", "product_type_member", "product_member"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user_contact_info": UserContactInfo.from_dict(obj["user_contact_info"]) if obj.get("user_contact_info") is not None else None,
            "global_role": GlobalRole.from_dict(obj["global_role"]) if obj.get("global_role") is not None else None,
            "dojo_group_member": [DojoGroupMember.from_dict(_item) for _item in obj["dojo_group_member"]] if obj.get("dojo_group_member") is not None else None,
            "product_type_member": [ProductTypeMember.from_dict(_item) for _item in obj["product_type_member"]] if obj.get("product_type_member") is not None else None,
            "product_member": [ProductMember.from_dict(_item) for _item in obj["product_member"]] if obj.get("product_member") is not None else None
        })
        return _obj
