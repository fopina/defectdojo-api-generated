...
------------- | ------------- | -------------
[**list**](ConfigurationPermissionsApi.md#list) | **GET** /api/v2/configuration_permissions/ | 
[**retrieve**](ConfigurationPermissionsApi.md#retrieve) | **GET** /api/v2/configuration_permissions/{id}/ | 


# **list**
> PaginatedConfigurationPermissionList list(codename=codename, id=id, limit=limit, name=name, offset=offset)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list(codename=codename, id=id, limit=limit, name=name, offset=offset)
        print("The response of ConfigurationPermissionsApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConfigurationPermissionsApi->list: %s\n" % e)
```
...
# **retrieve**
> ConfigurationPermission retrieve(id)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ConfigurationPermissionsApi->retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConfigurationPermissionsApi->retrieve: %s\n" % e)
```
