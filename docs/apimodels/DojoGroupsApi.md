...
------------- | ------------- | -------------
[**create**](DojoGroupsApi.md#create) | **POST** /api/v2/dojo_groups/ | 
[**delete_preview_list**](DojoGroupsApi.md#delete_preview_list) | **GET** /api/v2/dojo_groups/{id}/delete_preview/ | 
[**destroy**](DojoGroupsApi.md#destroy) | **DELETE** /api/v2/dojo_groups/{id}/ | 
[**list**](DojoGroupsApi.md#list) | **GET** /api/v2/dojo_groups/ | 
[**partial_update**](DojoGroupsApi.md#partial_update) | **PATCH** /api/v2/dojo_groups/{id}/ | 
[**retrieve**](DojoGroupsApi.md#retrieve) | **GET** /api/v2/dojo_groups/{id}/ | 
[**update**](DojoGroupsApi.md#update) | **PUT** /api/v2/dojo_groups/{id}/ | 
