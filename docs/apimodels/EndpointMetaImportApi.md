...
------------- | ------------- | -------------
[**create**](EndpointMetaImportApi.md#create) | **POST** /api/v2/endpoint_meta_import/ | 


# **create**
> EndpointMetaImporter create(file=file, create_endpoints=create_endpoints, create_tags=create_tags, create_dojo_meta=create_dojo_meta, product_name=product_name, product=product)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.create(file=file, create_endpoints=create_endpoints, create_tags=create_tags, create_dojo_meta=create_dojo_meta, product_name=product_name, product=product)
        print("The response of EndpointMetaImportApi->create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EndpointMetaImportApi->create: %s\n" % e)
```
