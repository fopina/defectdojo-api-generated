...
------------- | ------------- | -------------
[**create**](EndpointsApi.md#create) | **POST** /api/v2/endpoints/ | 
[**delete_preview_list**](EndpointsApi.md#delete_preview_list) | **GET** /api/v2/endpoints/{id}/delete_preview/ | 
[**destroy**](EndpointsApi.md#destroy) | **DELETE** /api/v2/endpoints/{id}/ | 
[**generate_report_create**](EndpointsApi.md#generate_report_create) | **POST** /api/v2/endpoints/{id}/generate_report/ | 
[**list**](EndpointsApi.md#list) | **GET** /api/v2/endpoints/ | 
[**partial_update**](EndpointsApi.md#partial_update) | **PATCH** /api/v2/endpoints/{id}/ | 
[**retrieve**](EndpointsApi.md#retrieve) | **GET** /api/v2/endpoints/{id}/ | 
[**update**](EndpointsApi.md#update) | **PUT** /api/v2/endpoints/{id}/ | 
