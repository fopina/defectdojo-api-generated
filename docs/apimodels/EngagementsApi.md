...
------------- | ------------- | -------------
[**accept_risks_create**](EngagementsApi.md#accept_risks_create) | **POST** /api/v2/engagements/{id}/accept_risks/ | 
[**close_create**](EngagementsApi.md#close_create) | **POST** /api/v2/engagements/{id}/close/ | 
[**complete_checklist_create**](EngagementsApi.md#complete_checklist_create) | **POST** /api/v2/engagements/{id}/complete_checklist/ | 
[**complete_checklist_retrieve**](EngagementsApi.md#complete_checklist_retrieve) | **GET** /api/v2/engagements/{id}/complete_checklist/ | 
[**create**](EngagementsApi.md#create) | **POST** /api/v2/engagements/ | 
[**delete_preview_list**](EngagementsApi.md#delete_preview_list) | **GET** /api/v2/engagements/{id}/delete_preview/ | 
[**destroy**](EngagementsApi.md#destroy) | **DELETE** /api/v2/engagements/{id}/ | 
[**files_create**](EngagementsApi.md#files_create) | **POST** /api/v2/engagements/{id}/files/ | 
[**files_download_retrieve**](EngagementsApi.md#files_download_retrieve) | **GET** /api/v2/engagements/{id}/files/download/{file_id}/ | 
[**files_retrieve**](EngagementsApi.md#files_retrieve) | **GET** /api/v2/engagements/{id}/files/ | 
[**generate_report_create**](EngagementsApi.md#generate_report_create) | **POST** /api/v2/engagements/{id}/generate_report/ | 
[**list**](EngagementsApi.md#list) | **GET** /api/v2/engagements/ | 
[**notes_create**](EngagementsApi.md#notes_create) | **POST** /api/v2/engagements/{id}/notes/ | 
[**notes_retrieve**](EngagementsApi.md#notes_retrieve) | **GET** /api/v2/engagements/{id}/notes/ | 
[**partial_update**](EngagementsApi.md#partial_update) | **PATCH** /api/v2/engagements/{id}/ | 
[**reopen_create**](EngagementsApi.md#reopen_create) | **POST** /api/v2/engagements/{id}/reopen/ | 
[**retrieve**](EngagementsApi.md#retrieve) | **GET** /api/v2/engagements/{id}/ | 
[**update**](EngagementsApi.md#update) | **PUT** /api/v2/engagements/{id}/ | 
[**update_jira_epic_create**](EngagementsApi.md#update_jira_epic_create) | **POST** /api/v2/engagements/{id}/update_jira_epic/ | 
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->accept_risks_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->accept_risks_create: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.close_create(id)
    except Exception as e:
        print("Exception when calling EngagementsApi->close_create: %s\n" % e)
```
...
> EngagementCheckList complete_checklist_create(id, engagement_check_list_request=engagement_check_list_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.complete_checklist_create(id, engagement_check_list_request=engagement_check_list_request)
        print("The response of EngagementsApi->complete_checklist_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->complete_checklist_create: %s\n" % e)
```
...
> Engagement complete_checklist_retrieve(id)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.complete_checklist_retrieve(id)
        print("The response of EngagementsApi->complete_checklist_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->complete_checklist_retrieve: %s\n" % e)
```
...
# **create**
> Engagement create(engagement_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.create(engagement_request)
        print("The response of EngagementsApi->create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->create: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->delete_preview_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->delete_preview_list: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling EngagementsApi->destroy: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->files_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->files_create: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->files_download_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->files_download_retrieve: %s\n" % e)
```
...
# **files_retrieve**
> EngagementToFiles files_retrieve(id)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->files_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->files_retrieve: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->generate_report_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->generate_report_create: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    status = 'status_example' # str | * `Not Started` - Not Started * `Blocked` - Blocked * `Cancelled` - Cancelled * `Completed` - Completed * `In Progress` - In Progress * `On Hold` - On Hold * `Scheduled` - Scheduled * `Waiting for Resource` - Waiting for Resource (optional)
    ...
    try:
        api_response = api_instance.list(active=active, api_test=api_test, has_tags=has_tags, id=id, limit=limit, name=name, not_product__tags=not_product__tags, not_tag=not_tag, not_tags=not_tags, o=o, offset=offset, pen_test=pen_test, product=product, product__prod_type=product__prod_type, product__tags=product__tags, product__tags__and=product__tags__and, report_type=report_type, requester=requester, status=status, tag=tag, tags=tags, tags__and=tags__and, target_end=target_end, target_start=target_start, threat_model=threat_model, updated=updated, version=version)
        print("The response of EngagementsApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->list: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->notes_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->notes_create: %s\n" % e)
```
...
# **notes_retrieve**
> EngagementToNotes notes_retrieve(id)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->notes_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->notes_retrieve: %s\n" % e)
```
...
# **partial_update**
> Engagement partial_update(id, patched_engagement_request=patched_engagement_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.partial_update(id, patched_engagement_request=patched_engagement_request)
        print("The response of EngagementsApi->partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->partial_update: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.reopen_create(id)
    except Exception as e:
        print("Exception when calling EngagementsApi->reopen_create: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EngagementsApi->retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->retrieve: %s\n" % e)
```
...
# **update**
> Engagement update(id, engagement_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.update(id, engagement_request)
        print("The response of EngagementsApi->update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->update: %s\n" % e)
```
...
> EngagementUpdateJiraEpic update_jira_epic_create(id, engagement_update_jira_epic_request=engagement_update_jira_epic_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.update_jira_epic_create(id, engagement_update_jira_epic_request=engagement_update_jira_epic_request)
        print("The response of EngagementsApi->update_jira_epic_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EngagementsApi->update_jira_epic_create: %s\n" % e)
```
