...
------------- | ------------- | -------------
[**create**](FindingTemplatesApi.md#create) | **POST** /api/v2/finding_templates/ | 
[**delete_preview_list**](FindingTemplatesApi.md#delete_preview_list) | **GET** /api/v2/finding_templates/{id}/delete_preview/ | 
[**destroy**](FindingTemplatesApi.md#destroy) | **DELETE** /api/v2/finding_templates/{id}/ | 
[**list**](FindingTemplatesApi.md#list) | **GET** /api/v2/finding_templates/ | 
[**partial_update**](FindingTemplatesApi.md#partial_update) | **PATCH** /api/v2/finding_templates/{id}/ | 
[**retrieve**](FindingTemplatesApi.md#retrieve) | **GET** /api/v2/finding_templates/{id}/ | 
[**update**](FindingTemplatesApi.md#update) | **PUT** /api/v2/finding_templates/{id}/ | 


# **create**
> FindingTemplate create(finding_template_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.create(finding_template_request)
        print("The response of FindingTemplatesApi->create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FindingTemplatesApi->create: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FindingTemplatesApi->delete_preview_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FindingTemplatesApi->delete_preview_list: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling FindingTemplatesApi->destroy: %s\n" % e)
```
...
# **list**
> PaginatedFindingTemplateList list(cwe=cwe, description=description, id=id, limit=limit, mitigation=mitigation, not_tag=not_tag, not_tags=not_tags, o=o, offset=offset, severity=severity, tag=tag, tags=tags, tags__and=tags__and, title=title)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list(cwe=cwe, description=description, id=id, limit=limit, mitigation=mitigation, not_tag=not_tag, not_tags=not_tags, o=o, offset=offset, severity=severity, tag=tag, tags=tags, tags__and=tags__and, title=title)
        print("The response of FindingTemplatesApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FindingTemplatesApi->list: %s\n" % e)
```
...
# **partial_update**
> FindingTemplate partial_update(id, patched_finding_template_request=patched_finding_template_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.partial_update(id, patched_finding_template_request=patched_finding_template_request)
        print("The response of FindingTemplatesApi->partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FindingTemplatesApi->partial_update: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FindingTemplatesApi->retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FindingTemplatesApi->retrieve: %s\n" % e)
```
...
# **update**
> FindingTemplate update(id, finding_template_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.update(id, finding_template_request)
        print("The response of FindingTemplatesApi->update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FindingTemplatesApi->update: %s\n" % e)
```
