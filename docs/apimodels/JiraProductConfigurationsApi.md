...
------------- | ------------- | -------------
[**create**](JiraProductConfigurationsApi.md#create) | **POST** /api/v2/jira_product_configurations/ | 
[**delete_preview_list**](JiraProductConfigurationsApi.md#delete_preview_list) | **GET** /api/v2/jira_product_configurations/{id}/delete_preview/ | 
[**destroy**](JiraProductConfigurationsApi.md#destroy) | **DELETE** /api/v2/jira_product_configurations/{id}/ | 
[**list**](JiraProductConfigurationsApi.md#list) | **GET** /api/v2/jira_product_configurations/ | 
[**partial_update**](JiraProductConfigurationsApi.md#partial_update) | **PATCH** /api/v2/jira_product_configurations/{id}/ | 
[**retrieve**](JiraProductConfigurationsApi.md#retrieve) | **GET** /api/v2/jira_product_configurations/{id}/ | 
[**update**](JiraProductConfigurationsApi.md#update) | **PUT** /api/v2/jira_product_configurations/{id}/ | 
