# defectdojo_api_generated.JiraProjectsApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create**](JiraProjectsApi.md#create) | **POST** /api/v2/jira_projects/ | 
[**delete_preview_list**](JiraProjectsApi.md#delete_preview_list) | **GET** /api/v2/jira_projects/{id}/delete_preview/ | 
[**destroy**](JiraProjectsApi.md#destroy) | **DELETE** /api/v2/jira_projects/{id}/ | 
[**list**](JiraProjectsApi.md#list) | **GET** /api/v2/jira_projects/ | 
[**partial_update**](JiraProjectsApi.md#partial_update) | **PATCH** /api/v2/jira_projects/{id}/ | 
[**retrieve**](JiraProjectsApi.md#retrieve) | **GET** /api/v2/jira_projects/{id}/ | 
[**update**](JiraProjectsApi.md#update) | **PUT** /api/v2/jira_projects/{id}/ | 
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JiraProjectsApi->create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JiraProjectsApi->create: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JiraProjectsApi->delete_preview_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JiraProjectsApi->delete_preview_list: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling JiraProjectsApi->destroy: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JiraProjectsApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JiraProjectsApi->list: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JiraProjectsApi->partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JiraProjectsApi->partial_update: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JiraProjectsApi->retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JiraProjectsApi->retrieve: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JiraProjectsApi->update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JiraProjectsApi->update: %s\n" % e)
```
