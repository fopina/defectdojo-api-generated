...
------------- | ------------- | -------------
[**list**](NotesApi.md#list) | **GET** /api/v2/notes/ | 
[**partial_update**](NotesApi.md#partial_update) | **PATCH** /api/v2/notes/{id}/ | 
[**retrieve**](NotesApi.md#retrieve) | **GET** /api/v2/notes/{id}/ | 
[**update**](NotesApi.md#update) | **PUT** /api/v2/notes/{id}/ | 
