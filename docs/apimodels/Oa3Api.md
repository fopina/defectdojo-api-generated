...
------------- | ------------- | -------------
[**schema_retrieve**](Oa3Api.md#schema_retrieve) | **GET** /api/v2/oa3/schema/ | 
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of Oa3Api->schema_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling Oa3Api->schema_retrieve: %s\n" % e)
```
