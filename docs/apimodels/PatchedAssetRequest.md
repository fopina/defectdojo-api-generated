...
json = "{}"
# create an instance of PatchedAssetRequest from a JSON string
patched_asset_request_instance = PatchedAssetRequest.from_json(json)
# print the JSON string representation of the object
print(PatchedAssetRequest.to_json())

# convert the object into a dict
patched_asset_request_dict = patched_asset_request_instance.to_dict()
# create an instance of PatchedAssetRequest from a dict
patched_asset_request_from_dict = PatchedAssetRequest.from_dict(patched_asset_request_dict)
```
