...
------------- | ------------- | -------------
[**create**](ProductsApi.md#create) | **POST** /api/v2/products/ | 
[**delete_preview_list**](ProductsApi.md#delete_preview_list) | **GET** /api/v2/products/{id}/delete_preview/ | 
[**destroy**](ProductsApi.md#destroy) | **DELETE** /api/v2/products/{id}/ | 
[**generate_report_create**](ProductsApi.md#generate_report_create) | **POST** /api/v2/products/{id}/generate_report/ | 
[**list**](ProductsApi.md#list) | **GET** /api/v2/products/ | 
[**partial_update**](ProductsApi.md#partial_update) | **PATCH** /api/v2/products/{id}/ | 
[**retrieve**](ProductsApi.md#retrieve) | **GET** /api/v2/products/{id}/ | 
[**update**](ProductsApi.md#update) | **PUT** /api/v2/products/{id}/ | 
