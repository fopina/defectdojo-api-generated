...
------------- | ------------- | -------------
[**list**](QuestionnaireAnsweredQuestionnairesApi.md#list) | **GET** /api/v2/questionnaire_answered_questionnaires/ | 
[**retrieve**](QuestionnaireAnsweredQuestionnairesApi.md#retrieve) | **GET** /api/v2/questionnaire_answered_questionnaires/{id}/ | 


# **list**
> PaginatedQuestionnaireAnsweredSurveyList list(limit=limit, offset=offset, prefetch=prefetch)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of QuestionnaireAnsweredQuestionnairesApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling QuestionnaireAnsweredQuestionnairesApi->list: %s\n" % e)
```
...
# **retrieve**
> QuestionnaireAnsweredSurvey retrieve(id, prefetch=prefetch)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of QuestionnaireAnsweredQuestionnairesApi->retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling QuestionnaireAnsweredQuestionnairesApi->retrieve: %s\n" % e)
```
