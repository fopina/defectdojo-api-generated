...
------------- | ------------- | -------------
[**list**](QuestionnaireAnswersApi.md#list) | **GET** /api/v2/questionnaire_answers/ | 
[**retrieve**](QuestionnaireAnswersApi.md#retrieve) | **GET** /api/v2/questionnaire_answers/{id}/ | 


# **list**
> PaginatedQuestionnaireAnswerList list(limit=limit, offset=offset)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of QuestionnaireAnswersApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling QuestionnaireAnswersApi->list: %s\n" % e)
```
...
# **retrieve**
> QuestionnaireAnswer retrieve(id)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of QuestionnaireAnswersApi->retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling QuestionnaireAnswersApi->retrieve: %s\n" % e)
```
