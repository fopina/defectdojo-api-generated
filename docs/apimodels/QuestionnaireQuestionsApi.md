# defectdojo_api_generated.QuestionnaireQuestionsApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list**](QuestionnaireQuestionsApi.md#list) | **GET** /api/v2/questionnaire_questions/ | 
[**retrieve**](QuestionnaireQuestionsApi.md#retrieve) | **GET** /api/v2/questionnaire_questions/{id}/ | 


# **list**
> PaginatedQuestionnaireQuestionList list(limit=limit, offset=offset)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of QuestionnaireQuestionsApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling QuestionnaireQuestionsApi->list: %s\n" % e)
```
...
# **retrieve**
> QuestionnaireQuestion retrieve(id)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of QuestionnaireQuestionsApi->retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling QuestionnaireQuestionsApi->retrieve: %s\n" % e)
```
