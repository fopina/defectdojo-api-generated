...
------------- | ------------- | -------------
[**list**](SystemSettingsApi.md#list) | **GET** /api/v2/system_settings/ | 
[**partial_update**](SystemSettingsApi.md#partial_update) | **PATCH** /api/v2/system_settings/{id}/ | 
[**update**](SystemSettingsApi.md#update) | **PUT** /api/v2/system_settings/{id}/ | 


# **list**
> PaginatedSystemSettingsList list(limit=limit, offset=offset)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SystemSettingsApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemSettingsApi->list: %s\n" % e)
```
...
# **partial_update**
> SystemSettings partial_update(id, patched_system_settings_request=patched_system_settings_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.partial_update(id, patched_system_settings_request=patched_system_settings_request)
        print("The response of SystemSettingsApi->partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemSettingsApi->partial_update: %s\n" % e)
```
...
# **update**
> SystemSettings update(id, system_settings_request=system_settings_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.update(id, system_settings_request=system_settings_request)
        print("The response of SystemSettingsApi->update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemSettingsApi->update: %s\n" % e)
```
