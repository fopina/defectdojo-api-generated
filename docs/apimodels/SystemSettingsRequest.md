...
system_settings_request_instance = SystemSettingsRequest.from_json(json)
# print the JSON string representation of the object
print(SystemSettingsRequest.to_json())

# convert the object into a dict
system_settings_request_dict = system_settings_request_instance.to_dict()
# create an instance of SystemSettingsRequest from a dict
system_settings_request_from_dict = SystemSettingsRequest.from_dict(system_settings_request_dict)
```
