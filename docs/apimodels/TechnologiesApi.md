...
------------- | ------------- | -------------
[**create**](TechnologiesApi.md#create) | **POST** /api/v2/technologies/ | 
[**delete_preview_list**](TechnologiesApi.md#delete_preview_list) | **GET** /api/v2/technologies/{id}/delete_preview/ | 
[**destroy**](TechnologiesApi.md#destroy) | **DELETE** /api/v2/technologies/{id}/ | 
[**list**](TechnologiesApi.md#list) | **GET** /api/v2/technologies/ | 
[**partial_update**](TechnologiesApi.md#partial_update) | **PATCH** /api/v2/technologies/{id}/ | 
[**retrieve**](TechnologiesApi.md#retrieve) | **GET** /api/v2/technologies/{id}/ | 
[**update**](TechnologiesApi.md#update) | **PUT** /api/v2/technologies/{id}/ | 


# **create**
> AppAnalysis create(app_analysis_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.create(app_analysis_request)
        print("The response of TechnologiesApi->create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TechnologiesApi->create: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TechnologiesApi->delete_preview_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TechnologiesApi->delete_preview_list: %s\n" % e)
```
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TechnologiesApi->destroy: %s\n" % e)
```
...
# **list**
> PaginatedAppAnalysisList list(limit=limit, name=name, not_tag=not_tag, not_tags=not_tags, offset=offset, prefetch=prefetch, product=product, tag=tag, tags=tags, tags__and=tags__and, user=user, version=version)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list(limit=limit, name=name, not_tag=not_tag, not_tags=not_tags, offset=offset, prefetch=prefetch, product=product, tag=tag, tags=tags, tags__and=tags__and, user=user, version=version)
        print("The response of TechnologiesApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TechnologiesApi->list: %s\n" % e)
```
...
# **partial_update**
> AppAnalysis partial_update(id, patched_app_analysis_request=patched_app_analysis_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.partial_update(id, patched_app_analysis_request=patched_app_analysis_request)
        print("The response of TechnologiesApi->partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TechnologiesApi->partial_update: %s\n" % e)
```
...
# **retrieve**
> AppAnalysis retrieve(id, prefetch=prefetch)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TechnologiesApi->retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TechnologiesApi->retrieve: %s\n" % e)
```
...
# **update**
> AppAnalysis update(id, app_analysis_request)
...
with defectdojo_api_generated.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.update(id, app_analysis_request)
        print("The response of TechnologiesApi->update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TechnologiesApi->update: %s\n" % e)
```
