...
------------- | ------------- | -------------
[**create**](TestImportsApi.md#create) | **POST** /api/v2/test_imports/ | 
[**delete_preview_list**](TestImportsApi.md#delete_preview_list) | **GET** /api/v2/test_imports/{id}/delete_preview/ | 
[**destroy**](TestImportsApi.md#destroy) | **DELETE** /api/v2/test_imports/{id}/ | 
[**list**](TestImportsApi.md#list) | **GET** /api/v2/test_imports/ | 
[**partial_update**](TestImportsApi.md#partial_update) | **PATCH** /api/v2/test_imports/{id}/ | 
[**retrieve**](TestImportsApi.md#retrieve) | **GET** /api/v2/test_imports/{id}/ | 
[**update**](TestImportsApi.md#update) | **PUT** /api/v2/test_imports/{id}/ | 
