...
------------- | ------------- | -------------
[**create**](UserContactInfosApi.md#create) | **POST** /api/v2/user_contact_infos/ | 
[**delete_preview_list**](UserContactInfosApi.md#delete_preview_list) | **GET** /api/v2/user_contact_infos/{id}/delete_preview/ | 
[**destroy**](UserContactInfosApi.md#destroy) | **DELETE** /api/v2/user_contact_infos/{id}/ | 
[**list**](UserContactInfosApi.md#list) | **GET** /api/v2/user_contact_infos/ | 
[**partial_update**](UserContactInfosApi.md#partial_update) | **PATCH** /api/v2/user_contact_infos/{id}/ | 
[**retrieve**](UserContactInfosApi.md#retrieve) | **GET** /api/v2/user_contact_infos/{id}/ | 
[**update**](UserContactInfosApi.md#update) | **PUT** /api/v2/user_contact_infos/{id}/ | 
