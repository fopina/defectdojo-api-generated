...
from defectdojo_api_generated.models.asset_prefetch import AssetPrefetch as _AssetPrefetch


class TestAssetPrefetch(unittest.TestCase):
    """AssetPrefetch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> _AssetPrefetch:
        """Test AssetPrefetch
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AssetPrefetch`
        """
        model = _AssetPrefetch()
        if include_optional:
            return _AssetPrefetch(
