...
from defectdojo_api_generated.models.endpoint_request import EndpointRequest as _EndpointRequest
...
class TestEndpointRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _EndpointRequest:
