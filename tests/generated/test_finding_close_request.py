...
from defectdojo_api_generated.models.finding_close_request import FindingCloseRequest as _FindingCloseRequest
...
class TestFindingCloseRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _FindingCloseRequest:
        ...
        """
        model = _FindingCloseRequest()
        if include_optional:
            return _FindingCloseRequest(
                is_mitigated = True,
