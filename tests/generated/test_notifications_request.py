...
from defectdojo_api_generated.models.notifications_request import NotificationsRequest as _NotificationsRequest
...
class TestNotificationsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _NotificationsRequest:
