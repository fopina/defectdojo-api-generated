...
from defectdojo_api_generated.models.paginated_asset_group_list import (
    PaginatedAssetGroupList as _PaginatedAssetGroupList,
)


class TestPaginatedAssetGroupList(unittest.TestCase):
    """PaginatedAssetGroupList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> _PaginatedAssetGroupList:
        """Test PaginatedAssetGroupList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedAssetGroupList`
        """
        model = _PaginatedAssetGroupList()
        if include_optional:
            return _PaginatedAssetGroupList(
                count = 123,
                next = 'http://api.example.org/accounts/?offset=400&limit=100',
                previous = 'http://api.example.org/accounts/?offset=200&limit=100',
                results = [
                    defectdojo_api_generated.models.asset_group.AssetGroup(
                        id = 56, 
                        asset = 56, 
                        group = 56, 
                        role = 56, 
                        prefetch = defectdojo_api_generated.models.asset_group_prefetch.AssetGroup_prefetch(
                            group = {
    ...
    def testPaginatedAssetGroupList(self):
        """Test PaginatedAssetGroupList"""
