...
from defectdojo_api_generated.models.paginated_dojo_group_list import PaginatedDojoGroupList as _PaginatedDojoGroupList
...
class TestPaginatedDojoGroupList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _PaginatedDojoGroupList:
        ...
        """
        model = _PaginatedDojoGroupList()
        if include_optional:
            return _PaginatedDojoGroupList(
                count = 123,
