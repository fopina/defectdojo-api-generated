...
from defectdojo_api_generated.models.paginated_dojo_group_member_list import (
    PaginatedDojoGroupMemberList as _PaginatedDojoGroupMemberList,
)
...
class TestPaginatedDojoGroupMemberList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _PaginatedDojoGroupMemberList:
        ...
        """
        model = _PaginatedDojoGroupMemberList()
        if include_optional:
            return _PaginatedDojoGroupMemberList(
                count = 123,
