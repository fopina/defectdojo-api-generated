...
from defectdojo_api_generated.models.paginated_language_type_list import (
    PaginatedLanguageTypeList as _PaginatedLanguageTypeList,
)
...
class TestPaginatedLanguageTypeList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _PaginatedLanguageTypeList:
        ...
        """
        model = _PaginatedLanguageTypeList()
        if include_optional:
            return _PaginatedLanguageTypeList(
                count = 123,
