...
from defectdojo_api_generated.models.paginated_notifications_list import (
    PaginatedNotificationsList as _PaginatedNotificationsList,
)
...
class TestPaginatedNotificationsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _PaginatedNotificationsList:
        ...
        """
        model = _PaginatedNotificationsList()
        if include_optional:
            return _PaginatedNotificationsList(
                count = 123,
