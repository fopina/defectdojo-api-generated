...
from defectdojo_api_generated.models.paginated_product_group_list import (
    PaginatedProductGroupList as _PaginatedProductGroupList,
)
...
class TestPaginatedProductGroupList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _PaginatedProductGroupList:
        ...
        """
        model = _PaginatedProductGroupList()
        if include_optional:
            return _PaginatedProductGroupList(
                count = 123,
