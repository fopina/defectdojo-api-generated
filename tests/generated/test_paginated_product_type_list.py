...
from defectdojo_api_generated.models.paginated_product_type_list import (
    PaginatedProductTypeList as _PaginatedProductTypeList,
)
...
class TestPaginatedProductTypeList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _PaginatedProductTypeList:
        ...
        """
        model = _PaginatedProductTypeList()
        if include_optional:
            return _PaginatedProductTypeList(
                count = 123,
