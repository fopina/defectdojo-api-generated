...
from defectdojo_api_generated.models.paginated_role_list import PaginatedRoleList as _PaginatedRoleList
...
class TestPaginatedRoleList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _PaginatedRoleList:
        ...
        """
        model = _PaginatedRoleList()
        if include_optional:
            return _PaginatedRoleList(
                count = 123,
