...
from defectdojo_api_generated.models.product_request import ProductRequest as _ProductRequest
...
class TestProductRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _ProductRequest:
        """Test ProductRequest
