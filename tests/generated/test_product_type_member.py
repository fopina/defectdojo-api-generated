...
from defectdojo_api_generated.models.product_type_member import ProductTypeMember as _ProductTypeMember
...
class TestProductTypeMember(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> _ProductTypeMember:
        ...
        """
        model = _ProductTypeMember()
        if include_optional:
            return _ProductTypeMember(
                id = 56,
                product_type = 56,
                user = 56,
                role = 56,
